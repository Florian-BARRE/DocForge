  ...
  return (
    <div>
      <div className="search-stage-description" style={{ marginBottom: 10 }}>
        Embed provider is derived from the ingestion config and cannot be changed here.
      </div>
      <div className="stage-panel-row" style={{ marginBottom: 8 }}>
        <span className="stage-panel-label">Model</span>
        <span className="stage-panel-value">
          {configState?.embedding_model ?? '—'}
        </span>
      </div>
      <div className="stage-panel-row">
        <span className="stage-panel-label">Locality</span>
        <span className="stage-panel-value">
          {configState?.locality_policy ?? '—'}
        </span>
      </div>
    </div>
  )
