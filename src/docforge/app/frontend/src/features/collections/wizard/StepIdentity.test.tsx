...
function renderStep(extra: Record<string, unknown>, onExtraChange = vi.fn()) {
  return render(
    <StepIdentity
      mode="create"
      name="my-collection" onNameChange={vi.fn()}
...
describe("StepIdentity — trace verbosity promotion", () => {
  it("renders the Execution trace radiogroup without expanding 'Show technical details'", async () => {
    ...
    const shapeOption = screen.getByRole("radio", { name: /^Shape/ });
