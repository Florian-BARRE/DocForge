// ====== Code Summary ======
// A document's searchability toggle — flips `enabled` via PATCH /documents/{id}/enabled and
// reports the applied state back to the caller (the catalogue row or the document page header
// owns where that state lives).
...
interface DocumentEnabledToggleProps {
  documentId: string;
  enabled: boolean;
  onChanged: (enabled: boolean) => void;
}

export function DocumentEnabledToggle({ documentId, enabled, onChanged }: DocumentEnabledToggleProps) {
