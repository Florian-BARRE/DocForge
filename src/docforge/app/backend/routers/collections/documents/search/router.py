...
_SEARCH = [Depends(require_capability(Capability.SEARCH))]

router = APIRouter(tags=["search"])


@router.post("/search", response_model=SearchResponse, dependencies=_SEARCH)
@auto_handle_errors
...
@router.post("/{document_id}/search", response_model=SearchResponse, dependencies=_SEARCH)
@auto_handle_errors
