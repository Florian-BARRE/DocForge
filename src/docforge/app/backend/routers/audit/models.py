# ====== Code Summary ======
# Response models for the root-only audit-trail read endpoint: one immutable audit row (AuditEntry)
# and the keyset-paginated page envelope (AuditPage) that carries a page of rows plus the opaque
# cursor for the next page (null when the trail is exhausted).
