...
class CollectionModel(Base):
    ...
    # Resource-admission limit (Brique D) — kept as a column (NOT in the pipeline JSON blob) so it
    # never perturbs reindex semantics. NULL = no per-collection cap (fall back to global / unlimited).
