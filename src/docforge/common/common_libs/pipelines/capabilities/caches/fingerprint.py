# ====== Code Summary ======
# Merkle-DAG fingerprinting for the node-engine pipeline.
...
# Module-level shims preserve the flat import path for all existing callers.
...
# ─── Module-level shims ───────────────────────────────────────────────────────
# Preserve the flat import: ``from ...caches.fingerprint import compute_fingerprint``.
# All callers continue to work without referencing the helper class directly.
