# ====== Code Summary ======
# IngestStageEmbedIndexIndexHelpers — the index-side static helpers for the embed_index stage. Pure
# mappings with no I/O: assemble the named dense/sparse vector maps Qdrant upsert expects (content +
# one per planned field), and build the lean Qdrant payload (base provenance + filterable field
# values) for a chunk. Used by the assemble_points step.
...
class IngestStageEmbedIndexIndexHelpers:
    """
    ...
    def __new__(cls, *args: object, **kwargs: object) -> None:
        ...
        raise TypeError(
            "IngestStageEmbedIndexIndexHelpers is a static-only class and cannot be instantiated."
        )
...
__all__ = ["IngestStageEmbedIndexIndexHelpers"]
