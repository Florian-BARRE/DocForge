# ====== Code Summary ======
# IngestStageContextualizeStepContextualizeHelpers — the pure embed_text builder, ported byte-for-byte
# from the former S5ContextualizeStage._build_embed_text. It assembles each chunk's embed_text as
# [doc title] + section breadcrumb + chunk body. The breadcrumb is precomputed by the chunk stage
...
class IngestStageContextualizeStepContextualizeHelpers:
    """Static helpers for the contextualize step — pure embed_text assembly."""

    logger = loggerplusplus.bind(identifier="IngestStageContextualizeStepContextualizeHelpers")

    def __new__(cls, *args: object, **kwargs: object) -> None:
        """Block instantiation — this is a static-only helper class."""
        raise TypeError(
            "IngestStageContextualizeStepContextualizeHelpers is a static-only class "
...
__all__ = ["IngestStageContextualizeStepContextualizeHelpers"]
