...
# FIGURE/TABLE with its caption.  Extracted from the assembler so the dispatcher stays thin.
...
class ChunkFactoryHelpers:
    ...
    def make_chunk(
        ...
        Returns:
            Chunk: A fully constructed Chunk ready for contextualisation.
        """
        ...
        return Chunk(
            ...
            block_ids=block_ids,
            raw_text=raw_text,
            embed_text="",          # Filled by the contextualize stage from prov.heading_path + body
