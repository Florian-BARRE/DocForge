...
# (pack_segments, segments_to_chunk, split_section_to_chunks).
# All three methods are tightly coupled: pack_segments calls both segments_to_chunk
# and split_section_to_chunks, so they belong in the same file.
...
class FlatPackerHelpers:
    ...
    async def pack_segments(
        ...
        Args:
            ...
            make_chunk_fn (callable): Shared chunk factory.
