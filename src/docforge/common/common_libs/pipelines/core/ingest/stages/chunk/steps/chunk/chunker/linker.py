# ====== Code Summary ======
# CrossReferenceLinker — resolves intra-document references ("see Figure 3", "cf. Article 5",
# "Annexe A") to the chunk that actually holds that figure/table/section, and records the target
# ids in each chunk's prov["linked_chunk_ids"]. This makes a reference findable even when the cited
# element lives far away in the document.
