...
class PipelineState(BaseModel):
    ...
    Attributes:
        ...
        language_on (bool): Whether the document language-detection stage is enabled (default on).
        language_config (dict): The language node's config (mode auto/fixed + default_language).
