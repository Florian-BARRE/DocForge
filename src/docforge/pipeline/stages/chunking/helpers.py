# ====== Code Summary ======
# Shared, pure helpers for S4 chunking — token estimation, block→text rendering, sentence
# segmentation, heading-path utilities, provenance builders, and deterministic chunk UUIDs.
# No I/O; reused by the S4 orchestrator and every section splitter so they stay consistent.
...
class ChunkingHelpers:
    """
    Static-only helpers shared by the S4 orchestrator and the section splitters.
    ...
    def stable_chunk_uuid(
        ...
        Args:
            ...
            config_hash (str): S4 configuration hash.
