...
- `DocumentStaleness.evaluate` (`backend/routers/collections/documents/staleness.py`) — old=snapshot config (dicts), new=collection (ORM). Drives per-doc `stale` flag.
